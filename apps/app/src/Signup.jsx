            ...
            <div className="flex-1 flex items-center justify-center p-8 sm:p-12 relative overflow-y-auto">
                <div className="w-full max-w-[400px]">
                    ...
                    <p className="mt-8 text-center text-[13px] text-[#64748B]">
                        Already have an account? <a href={`${window.location.origin}/login`} className="font-bold text-[#2563EB] hover:text-[#1D4ED8] underline underline-offset-4">Sign in here</a>
                    </p>
                </div>
            </div>
        </div>
